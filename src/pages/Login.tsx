...
import FullScreenLoadingModal from '../components/Common/FullScreenLoadingModal';
...
const Login = () => {
  ...
  if (isSubmitting) {
    return (
      <FullScreenLoadingModal open title="Giriş yoxlanılır..." message="Zəhmət olmasa bir az gözləyin" />
    );
  }
  ...
  return (
    <>
      ...
      >
        {/* Header alanı (yükseklik: 64px mobil, 48px masaüstü) */}
        <Box
          sx={{
            width: '100%',
            height: { xs: 64, sm: 48 },
